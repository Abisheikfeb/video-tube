    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-pink-400 dark:bg-black">
      ...
      {pageName !== "video" && (
        ...
        <Link to="/" className="flex h-5 items-center">
          <img className="h-full hidden dark:md:block" src={viewtube_word} alt="Youtube"/>
          <img className="h-full md:hidden" src={viewtube_logo} alt="Youtube"/>
        </Link>
      </div>
      <div className="group flex items-center">
          ...
          <div className="flex items-center">
              ...
              <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
                <img src="https://xsgames.co/randomusers/assets/avatars/male/20.jpg" />
              </div>
          </div>
    </div>
